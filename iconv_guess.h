 ...
 *  char *to               : Specifies the temporary charset.
 *  size_t to_size         : Specifies the size of temporary charset.
 ...
 *  void
 */
extern void iconv_guess_encoding(char *from, size_t from_size, char *to, size_t to_size, const char **encodings, char *guessed_enc, int *error_num, int allowed_error_num);
 ...
 *
 */
extern int iconv_guess_convert(const char *to_encoding, char **from, size_t *from_size, char **to, size_t *to_size, const char **encodings, char *guessed_enc, int *error_num, int allowed_error_num);
